...
//
  //                  });
    ...
    public void onCheckBoxClicked (View view) {
        ...
        // Check which radio button was clicked.
        switch (view.getId()) {
            case R.id.chocolateSyrup:
                if (checked)
                    displayToast("Toppings: Chocolate Syrup");
                break;
            case R.id.sprinkles:
                if (checked)
                    displayToast("Toppings: Sprinkles");
                break;
            case R.id.crushedNuts:
                if (checked)
                    displayToast("Toppings: Crushed Nuts");
                break;
            case R.id.cherries:
                if (checked)
                    displayToast("Toppings: Cherries");
                break;
            case R.id.orioCookies:
                if (checked)
                    displayToast("Toppings: Orio Cookies Crumbles");
                break;
